...
желании скомпилировать файл rbook.el, это можно сделать, выбрав его
курсором в dired и нажав B (команда dired-do-byte-compile). Остальные файлы
(speak, mp3 и т.д.) никуда перемещать не надо, они должны находиться в
...
Нажатие `C-c a' (rbook-make-audio-book) запускает процесс изготовления
...
разбивки, позволяющим ориентироваться как на логику текста, так и на
